...
abstract class OrderNowOrder with _$OrderNowOrder {
  const factory OrderNowOrder({
    ...
    @JsonKey(name: 'delivery_charge') required double deliveryCharge,
    @JsonKey(name: 'original_delivery_charge') required double originalDeliveryCharge,
    @JsonKey(name: 'delivery_address_id') required int deliveryAddressId,
    @JsonKey(name: 'delivery_address') required String deliveryAddress,
    @JsonKey(name: 'schedule_at') required String scheduleAt,
    ...
    @JsonKey(name: 'store_discount_amount') required double storeDiscountAmount,
    @JsonKey(name: 'total_tax_amount') required double totalTaxAmount,
    @JsonKey(name: 'tax_percentage') required int taxPercentage,
    @JsonKey(name: 'coupon_discount_amount') required double couponDiscountAmount,
    @JsonKey(name: 'additional_charge') required double additionalCharge,
    @JsonKey(name: 'flash_admin_discount_amount') required double flashAdminDiscountAmount,
    @JsonKey(name: 'flash_store_discount_amount') required double flashStoreDiscountAmount,
    @JsonKey(name: 'extra_packaging_amount') required double extraPackagingAmount,
    @JsonKey(name: 'ref_bonus_amount') required double refBonusAmount,
    @JsonKey(name: 'module_type') required String moduleType,
  }) = _OrderNowOrder;
