...
GetModuleResponse _$GetModuleResponseFromJson(Map<String, dynamic> json) => GetModuleResponse(
...
Map<String, dynamic> _$GetModuleResponseToJson(GetModuleResponse instance) => <String, dynamic>{
  'id': instance.id,
