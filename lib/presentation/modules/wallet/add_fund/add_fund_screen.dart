...
class AddFundScreen extends BaseScreen<AddFundController> {
    ...
    return Padding(
      ...
      child: Obx(() {
        ...
        return AppButton(
          ...
          child: Text('Add Funds', style: AppTextStyles.typographyH9Medium.copyWith(color: Figma.theme.tokenColorsTextGreyHighest950)),
        );
      }),
    );
  }
  ...
  PreferredSizeWidget? buildAppBar(BuildContext context) {
    return AppBar(
      ...
      title: Text('Add Funds', style: AppTextStyles.typographyH9Medium.copyWith(color: Figma.theme.tokenColorsTextGreyHighest950)),
      leading: IconButton(
        onPressed: () => Get.back(),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Load this amount',
            style: AppTextStyles.typographyH6Medium.copyWith(color: Figma.theme.tokenColorsTextGreyHighest950),
          ),
          Text(
      ...
      child: Column(
        ...
        children: [
          Obx(() {
            ...
            return Container(
              ...
              child: TextField(
                ...
                style: AppTextStyles.typographyH7SemiBold.copyWith(color: Figma.theme.tokenColorsTextGreyHighest950),
                keyboardType: TextInputType.number,
                onChanged: controller.onAmountChanged,
                decoration: InputDecoration(
                  hintText: '0.00',
                  hintStyle: AppTextStyles.typographyH7SemiBold.copyWith(color: Figma.theme.tokenColorsTextGreyDefault500),
                  suffixIcon: hasValue
                      ? GestureDetector(
                  ...
                  prefixIcon: Padding(
                    ...
                    child: Text('\$', style: AppTextStyles.typographyH7SemiBold.copyWith(color: hasValue ? Figma.theme.tokenColorsTextGreyHighest950 : Figma.theme.tokenColorsTextGreyDefault500)),
                  ),
                  ...
                  border: isFilled
                      ? InputBorder.none
                      : OutlineInputBorder(
                          borderSide: BorderSide(color: Figma.theme.tokenColorsTextGreyLow300),
                          borderRadius: BorderRadius.circular(6),
                        ),
          ...
          Text(
            ...
            style: AppTextStyles.typographyH12Regular.copyWith(color: Figma.theme.tokenColorsTextGreyDefault500),
          ),
            ...
            (amount) => GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: controller.amountText.value == amount.toString() ? Figma.theme.tokenColorsStateBaseGrey950 : Figma.theme.tokenColorsStateGreyLowest50,
                ...
                child: Text(
                  ...
                  style: AppTextStyles.typographyH11Regular.copyWith(
                    color: controller.amountText.value == amount.toString() ? Figma.theme.tokenColorsTextGreyLowestWhite : Figma.theme.tokenColorsTextGreyHighest950,
                  ),
                ),
              ),
            ),
  ...
  Widget _buildPaymentMethod(BuildContext context) {
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Payment method', style: AppTextStyles.typographyH9Medium.copyWith(color: Figma.theme.tokenColorsTextGreyHighest950)),
            ...
            return GestureDetector(
              ...
              child: Row(
                children: [
                  ...
                  Text('${method.name} ****${method.last4}', style: AppTextStyles.typographyH10Medium.copyWith(color: Figma.theme.tokenColorsTextGreyHighest950)),
                  const Spacer(),
                  Assets.icons.icRightArrowChevron.svg(colorFilter: ColorFilter.mode(Figma.theme.tokenColorsTextGreyDefault500, BlendMode.srcIn)),
                ],
              ),
            );
          }),
    ...
    await showAppBottomSheet<PaymentMethod?>(
      ...
      child: Obx(() => Column(
            ...
            children: [
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          const SizedBox(width: 12),
                          Text('${entry.value.name} ****${entry.value.last4}', style: AppTextStyles.typographyH10Medium.copyWith(color: Figma.theme.tokenColorsTextGreyHighest950)),
                          const Spacer(),
                          tempSelected.value == entry.value
                              ? Assets.icons.icCheckmark.svg(colorFilter: ColorFilter.mode(Figma.theme.tokenColorsTextGreyHigh700, BlendMode.srcIn))
              ...
              const SizedBox(height: 16),
              Divider(height: 1, color: Figma.theme.tokenColorsStateGreyLowest50),
              Padding(
                ...
                child: AppButton(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text('Add Payment methods', style: AppTextStyles.typographyH10Medium.copyWith(color: Figma.theme.tokenColorsTextGreyHighest950)),
                    ],
                  ),
                ),
              ),
