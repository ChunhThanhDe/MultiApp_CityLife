...
class TrackDeliveryController extends BaseController {
  ...
  final RxList<TravelHistory> travelHistory = <TravelHistory>[
    TravelHistory(title: 'Out for delivery', desc: 'WINNIPEG, MB CA', date: '01-28-2025', time: '9:25 AM', color: const Color(0xFF5856D7)),
    TravelHistory(title: 'On the way', desc: 'WINNIPEG, MB CA', date: '01-27-2025', time: '9:25 AM', color: const Color(0xFF161A1D)),
    TravelHistory(title: 'On the way', desc: 'Mississauga, ON CA', date: '01-25-2025', time: '9:25 AM', color: const Color(0xFF161A1D)),
    TravelHistory(title: 'Arrive at Sorting Center', desc: 'Mississauga, ON CA', date: '01-24-2025', time: '9:25 AM', color: const Color(0xFF161A1D)),
    TravelHistory(title: 'Pick-up', desc: 'Mississauga, ON CA', date: '01-20-2025', time: '9:25 AM', color: const Color(0xFF161A1D)),
    TravelHistory(title: 'Label Created', desc: 'Mississauga, ON CA', date: '01-20-2025', time: '9:25 AM', color: const Color(0xFF161A1D)),
  ].obs;
}
