    ...
    return RepaintBoundary(
      child: AnimatedContainer(
        ...
        child: TabBar(
          ...
          indicatorWeight: 0,
          dividerColor: AppColors.backgroundSurfacePrimaryWhite.withValues(alpha: 0),
          indicator: BoxDecoration(
            borderRadius: BorderRadius.circular(borderRadius),
            color: indicatorColor ?? AppColors.backgroundSurfacePrimaryWhite,
            boxShadow: [BoxShadow(color: AppColors.textGreyHighest950.withValues(alpha: 0.12), blurRadius: 2, offset: const Offset(0, 1))],
          ),
          ...
          overlayColor: WidgetStateProperty.resolveWith<Color?>((Set<WidgetState> states) => AppColors.backgroundSurfacePrimaryWhite.withValues(alpha: 0)),
