...
class BannerSingleImageWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Padding(
        padding: EdgeInsets.only(right: index == totalItems - 1 ? 24 : 16, left: index == 0 ? 24 : 0),
        child: SizedBox(width: 175, height: 220, child: Stack(children: [_buildMainImage(), if (item.status != 1) _buildStatusOverlay()])),
      ),
    );
  }
